            ...
            <form method="get" class="filter-form" style="display: grid; gap: 15px; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));">
                <div>
                    ...
                    <input type="text" id="search" name="search" 
                           placeholder="ID, usuario, email o producto" 
                           value="<?= esc($search ?? '') ?>" 
                ...
                <div style="display: flex; gap: 10px; align-items: end;">
                    ...
                    <a href="<?= base_url('orders/all') ?>" style="padding: 10px 20px; border: 1px solid #232442; background-color: #fff; color: #232442; border-radius: 8px; text-decoration: none; text-align: center; flex: 1;">
                        🗑️ Limpiar
                    </a>
                </div>
            </form>
                ...
                <div class="order-card" style="margin-bottom: 20px; border: 1px solid #ddd; border-radius: 12px; padding: 20px; background: #fff;">
                    <div style="display: flex; justify-content: between; align-items: center; margin-bottom: 15px;">
                        ...
                        <a href="<?= base_url('orders/' . $order['id']) ?>" 
                           style="padding: 8px 16px; background: #4caf50; color: white; text-decoration: none; border-radius: 6px; font-size: 0.9em; font-weight: bold; transition: background 0.3s;">
                            🧾 Ver Comprobante
                        </a>
                    </div>
